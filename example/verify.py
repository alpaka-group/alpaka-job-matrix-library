...
def get_simple_expected_values() -> Dict[str, Dict[str, List[str]]]:
...
def get_complex_expected_values() -> Dict[str, Dict[str, List[str]]]:
    expected_values: Dict[str, Dict[str, List[str]]] = {}
...
def verify(combinations: List[Dict[str, Tuple[str, str]]]) -> bool:
    ...
    # expected_values = get_simple_expected_values()
    expected_values = get_complex_expected_values()
